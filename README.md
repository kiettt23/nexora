...
- Admin & Staff truy cập trang quản trị
- Customer truy cập storefront, giỏ hàng, thanh toán
...
```
Nexora/
├── Controllers/          # MVC Controllers (Home, Product, Cart, Order, Account, Admin*)
├── Data/
...
│   ├── Home/, Product/, Cart/, Order/, Account/  # Giao diện khách hàng
│   └── Admin*, AdminProduct/, AdminCategory/, AdminOrder/, AdminUser/, AdminConfig/
