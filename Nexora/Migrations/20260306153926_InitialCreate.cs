        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalPrice = table.Column<decimal>(type: "numeric(18,0)", nullable: true),
                    ...
                    ScreenSize = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 6, 15, 39, 23, 419, DateTimeKind.Utc).AddTicks(9729), "Smartphone cao cap", null, true, "Dien thoai", "dien-thoai", 1 },
                    { 2, new DateTime(2026, 3, 6, 15, 39, 23, 419, DateTimeKind.Utc).AddTicks(9735), "Laptop van phong va gaming", null, true, "Laptop", "laptop", 2 },
                    { 3, new DateTime(2026, 3, 6, 15, 39, 23, 419, DateTimeKind.Utc).AddTicks(9737), "May tinh bang", null, true, "Tablet", "tablet", 3 },
                    { 4, new DateTime(2026, 3, 6, 15, 39, 23, 419, DateTimeKind.Utc).AddTicks(9738), "Phu kien cong nghe", null, true, "Phu kien", "phu-kien", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ShopName", "string", "Nexora" },
                    { 2, "Phone", "string", "0123456789" },
                    { 3, "Email", "string", "contact@nexora.vn" },
                    { 4, "Address", "string", "TP. Ho Chi Minh, Viet Nam" }
                });
